...
param$minsplit <-  851 # minima cantidad de registros para que se haga el split
param$minbucket <-  357 # tamaño minimo de una hoja
param$maxdepth <-  10 # profundidad maxima del arbol
param$corte <- 9503
...
fwrite(dapply[, list(numero_de_cliente, Predicted)],
       file = "exp/KA2001/check_BO_public_2.csv",
       sep = ","
)