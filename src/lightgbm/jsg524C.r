...
PARAM <- list()
PARAM$experimento <- "KA5240C"
# uso top 1 de BO con undersampling al 10%
...
PARAM$finalmodel$num_iterations <- 548
PARAM$finalmodel$learning_rate <- 0.0572922569974455
PARAM$finalmodel$feature_fraction <- 0.239471734598722
PARAM$finalmodel$min_data_in_leaf <- 6
PARAM$finalmodel$num_leaves <- 1005
