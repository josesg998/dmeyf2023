...
PARAM <- list()
PARAM$experimento <- "KA8240B_primer_BO"
...
PARAM$finalmodel$num_iterations <- 585
PARAM$finalmodel$learning_rate <- 0.0617606441902943
PARAM$finalmodel$feature_fraction <- 0.9990195198073
PARAM$finalmodel$min_data_in_leaf <- 30414
PARAM$finalmodel$num_leaves <- 961
