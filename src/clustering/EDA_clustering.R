...
clusters <-fread("../datasets/exp_DRF2.csv",stringsAsFactors = T)

#importo las etiquetas
etiquetas <- readODS::read_ods("../datasets/DiccionarioDatos_2023.ods")

importance <- fread("../datasets/exp_DRF2_importance.txt",header = T,dec = ",")
...
pdf("exp/DRF/medias_clusters.pdf", width = 10, height = 5)
